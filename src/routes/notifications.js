...
// @access  Private
router.put('/:id/read', authenticate, genericValidation.id, async (req, res) => {
  try {
    const { id } = req.params;
...
router.post('/', authenticate, authorize('ADMIN', 'AD_MANAGER'), async (req, res) => {
  try {
    const { 
      userId, 
      userIds, 
...
// @desc    Get notification statistics (Admin/AD_Manager)
// @route   GET /api/notifications/stats
// @access  Private (ADMIN, AD_MANAGER)
router.get('/stats', authenticate, authorize('ADMIN', 'AD_MANAGER'), async (req, res) => {
  try {
